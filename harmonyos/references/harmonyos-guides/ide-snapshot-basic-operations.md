...
content_hash: sha256:130382e2086c562d9d4f6b5f474a61c1d4ececd6d98bde21676808d53019fe5c
---
...
1. 单击**ArkTS Snapshot**泳道的**options**下拉列表，可以设置是否需要抓取基础类型number的数据。默认不抓取。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ed/v3/EgO6zruITFmahN7DIsyl_A/zh-cn_image_0000002731382995.png)
2. 开始录制后观察**Memory**泳道的内存使用情况，在需要定位的时刻单击任务左上角的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2f/v3/D44kwbyAQuCczKkJA5P26A/zh-cn_image_0000002731382997.png "点击放大")启动一次快照，一次快照完成后会在**ArkTS Snapshot**泳道出现紫色区块。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cc/v3/XryzdRdFRfy-YAVKCTUmNA/zh-cn_image_0000002701823696.png "点击放大")
   ...
   * 带![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/77/v3/pnISEa5xSLqK3A-Yb8kbaw/zh-cn_image_0000002731542957.png "点击放大")标识的对象，表示其为全局对象，可以通过全局window对象直接访问。

   **说明** 

   * 在任务录制过程中，单击分析窗口左上角的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c9/v3/Wjl8Vx5TQ_uf8z4OoCBnJw/zh-cn_image_0000002731542951.png "点击放大")可启动内存回收机制。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3d/v3/qBRfIQjdSbmJ3fGlFbv_jw/zh-cn_image_0000002701663762.png "点击放大")
...
* Module：模块信息。
* Class：属性名称。
* Path：编译后的源码路径。支持通过点击属性名称旁边的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/09/v3/gVVPJkM1SvisVUTOiNIHGw/zh-cn_image_0000002731382973.png)图标直接跳转至工程中的代码位置，方便开发者快速调试。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b1/v3/9zARYWWpRfOzkJUQ6vzlkg/zh-cn_image_0000002731542963.png "点击放大")

若应用编译模式是release，且启用了源码混淆，方舟应用对象将展示混淆后的数据。支持在Attributes页签查看当前所选应用对象的源码信息。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7a/v3/hiL2UotsSl20N-AuUU4u2A/zh-cn_image_0000002731382987.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/50/v3/4uNPuweEQMygEYhKnnsnBQ/zh-cn_image_0000002731382975.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1d/v3/E0KGhyMRSgy2MXEy0XsZ2w/zh-cn_image_0000002731542949.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e0/v3/EjOF_FHATvKmPkcW_4qkuw/zh-cn_image_0000002731542953.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ff/v3/Ahs468unQS-C_fkO_axfNw/zh-cn_image_0000002731542947.png "点击放大")
...
从26.0.0版本开始，点击**Shortest Paths**页签左侧的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/90/v3/iInE5lApTaKFlqKKqR222w/zh-cn_image_0000002731382985.png "点击放大")按钮，可将页签中的数据导出到本地进行保存。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/72/v3/W1y_vJiWQty_9FC52vts2w/zh-cn_image_0000002731382983.png "点击放大")
...
此外，若调试应用工程存在对应的SourceMap文件，点击源码路径旁边的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0f/v3/hxpm8HJCQxeNZjyIR82PBg/zh-cn_image_0000002701823688.png)图标，可直接跳转至工程中的代码位置，方便开发者快速调试，否则需要导入调试应用对应的SourceMap文件后再点击按钮跳转到源码。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6a/v3/NGP2wT5XR9CiSnaF49kaJQ/zh-cn_image_0000002731382981.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2d/v3/iHUv1ghZT-C8JxI_r6pnfw/zh-cn_image_0000002701663774.png "点击放大")

目前支持单根路径搜索、指定数量的根路径搜索和展示所有根路径三种搜索模式，默认为单根搜索。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/FE0TrygGTWaE2OM1TCfRhQ/zh-cn_image_0000002731542955.png "点击放大")

设置完搜索模式后点击OK，右侧more区域会自动跳转至Shortest Paths页面展示搜索结果。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f3/v3/c5lvqDO_QOGuSt8qBWjWkw/zh-cn_image_0000002731382991.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/15/v3/65Ah_c3mSaWkdR4RChTyXQ/zh-cn_image_0000002731542965.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/B5zOdi5dSxm4m8IZtawm3A/zh-cn_image_0000002731542969.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/94/v3/Ded_HxbwQpyajR8SSrvQBQ/zh-cn_image_0000002731542967.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/28/v3/P0rGROOjT5qaROKPb7Gjwg/zh-cn_image_0000002731382977.png "点击放大")

设置完搜索模式后点击OK，底部页签会自动跳转至Graph页面展示搜索结果，红色标示的是中心节点，线段展示连接的两个节点之间的引用关系。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/aa/v3/ddBpTOEBRUSFy0M2lr_xDw/zh-cn_image_0000002701823694.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e6/v3/iv2dtw8BT26cKzjDGlNOaA/zh-cn_image_0000002701823686.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fd/v3/0feVbwEIQ7OdROZmRlpOHA/zh-cn_image_0000002731542961.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a3/v3/7M6oIx78Rpqx0wN63Wb4gA/zh-cn_image_0000002701823684.png "点击放大")
...
2. 离线导入文件成功后，在**Leaks**区域展示JSLeakWatcher监控采集到的内存泄漏对象。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0e/v3/epujVY7dQp6Hsh6H_Pu7Tg/zh-cn_image_0000002731382989.png "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/8slNVV9IRPKonNeHb8he3Q/zh-cn_image_0000002731382979.png "点击放大")

点击工具栏![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4c/v3/Z7GbTJWRR6mM_xlErlS2cw/zh-cn_image_0000002701663764.png)按钮，导入nameCache文件，Class显示为文件名称MyAbilityStage。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0d/v3/dXCRsW1BT5GspvW_drmxFg/zh-cn_image_0000002701663760.png "点击放大")
