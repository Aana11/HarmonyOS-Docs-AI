---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-app-analyzer-scenes
title: 场景化体检
breadcrumb: 指南 > 编写与调试应用 > 开发自测试 > 应用与元服务体检 > 场景化体检
category: harmonyos-guides
scraped_at: 2026-09-17T06:45:35+08:00
doc_updated_at: 2026-09-14
content_hash: sha256:59e7621cd263c5dcc6652bfcc37339447f32cb39279980fd5c2cf833b167376c
---
...
1. 通过以下任意一种方式，打开AppAnalyzer。
   ...
   * 在编辑窗口右侧的工具栏，点击**AppAnalyzer**或![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/U20ReMHVTiu1CU0ltyc2BA/zh-cn_image_0000002731382131.png)，打开AppAnalyzer页面。
...
1. 点击右上角![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0d/v3/vQov8zdPT5GxNHq9LEQdtQ/zh-cn_image_0000002731542113.png)图标选择Product、Target和构建模式，点击**Apply**后，在AppAnalyzer的首页中可查看对应的编译产物和构建模式。关于Product、Target、构建模式的介绍请参考[配置多目标产物](ide-customized-multi-targets-and-products-guides.md)和[指定构建模式](ide-hvigor-compilation-options-customizing-guide.md#section192461528194916)。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2e/v3/eJrb2yuDQ46eMrzLph7uMQ/zh-cn_image_0000002701822850.png)
2. 在**AppAnalyzer**页面，选择**场景化体检**，选择预置的体检卡片，或根据需要自定义卡片。
   * 点击预置的卡片开始体检，如需查看卡片包含的体检场景，请点击卡片右上角的![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5c/v3/v3IfaNTtQGmwrE74aiaeHA/zh-cn_image_0000002701822834.png)按钮，不同场景对应的检测指标请参考[体检场景](ide-app-analyzer-scenes.md#section578981218613)。
...
3. 开始体检后，请等待AppAnalyzer完成构建、签名、安装等操作。如果本次体检依赖Python三方库并且本地未安装，AppAnalyzer会同步下载安装三方库。在测试过程中，请保持连接的设备为解锁亮屏状态。
   * 如果是自动测试，根据界面提示，登录应用账号后点击继续按钮![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/40/v3/yFft6OZlSha-tXWFenGkhA/zh-cn_image_0000002731382119.png)，继续测试；或者无需登录账号，直接点击![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d0/v3/JuPT5LP2RJKycGPd59wBvQ/zh-cn_image_0000002731382143.png)按钮继续测试。
   * 如果是手动测试，根据界面提示，点击开始按钮![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f2/v3/U2Ok4CKsQGyV8NOqYrcSCQ/zh-cn_image_0000002701662904.png)开始录制，并手动遍历应用/元服务的功能。如果在录制时间范围内未遍历完成，可继续点击![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/16/v3/uSurxbFpRGSm_sqJ1yYrmw/zh-cn_image_0000002731382137.png)按钮，进行多次遍历，遍历完成后点击结束按钮![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/49/v3/-x5Ep-h5QBGgtKvce9sIlQ/zh-cn_image_0000002701822822.png)。
4. 查看测试报告，包含以下内容。
   ...
   * **优化建议**：针对可能的故障原因，给出对应的最佳实践，点击链接可跳转至官网文档。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a8/v3/Y7C3095pRpain6QE_HY2ug/zh-cn_image_0000002701662926.png)

### DevEco Studio 6.0.1 Beta1以下版本

1. 如果使用DevEco Studio 6.0.0 Beta2及以上的版本，支持在体检过程中自动编译构建打包。点击右上角![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/75/v3/gc-8xQkCTA28PgSXnqQynQ/zh-cn_image_0000002731382129.png)图标选择Product、Target和构建模式，关于Product、Target、构建模式的介绍请参考[配置多目标产物](ide-customized-multi-targets-and-products-guides.md)和[指定构建模式](ide-hvigor-compilation-options-customizing-guide.md#section192461528194916)。
2. 在**AppAnalyzer**页面，选择**场景化体检**，选择**自动**或**手动**方式，**模块**选择框选择HarmonyOS应用/元服务工程模块。
   ...
   * 支持同时添加多个模块，要求所有模块的bundleName相同，且只能包含一个entry。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/70/v3/58pd9s4bR9WRZLtSV7cTUA/zh-cn_image_0000002701662918.png)
...
4. 如果是手动方式，在安装应用/元服务完成后，需要根据提示手动遍历HarmonyOS应用/元服务的功能。手动遍历完成后点击**结束**按钮停止测试任务，等待数据解析完成后，查看测试结果如下。
   * 测试报告：检测结果的汇总信息，默认展示告警和失败的检测结果，点击**详情链接**可跳转到对应场景的详情报告。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/db/v3/3aUS6l_BRpukxrtc7B6jMg/zh-cn_image_0000002701662930.png)
   * 详情报告：给出详细的测试结果、相关的定位文件和对应的优化建议。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f0/v3/DLAHSqFlQiuyFfEu5PqXrA/zh-cn_image_0000002701662922.png)
...
| 场景 | 子场景 | 检测指标/检测项 | 应用或元服务场景 | 自动或手动方式 |
| --- | --- | --- | --- | --- |
| 页面间转场 | router或者navigation页面跳转 | [点击响应时延](performance-delay.md#section118706211961) | 应用，元服务 | 自动，手动 |
| [点击完成时延](performance-delay.md#section2406192820717) |
| [转场卡顿率](performance-frame-rate.md#section1591383182619) |
| [起播时延](performance-delay.md#section1140562816186) |
...
| [滑动卡顿率](performance-frame-rate.md#section159268494256) |
| [起播时延](performance-delay.md#section1140562816186) |
| swiper点击转场  （从DevEco Studio 6.0.2 Beta1版本开始支持） | [点击响应时延](performance-delay.md#section118706211961) |
| [点击完成时延](performance-delay.md#section2406192820717) |
| [转场卡顿率](performance-frame-rate.md#section1591383182619) |
| web场景  （从DevEco Studio 6.0.0 Beta2版本开始支持） | web页面跳转 | [点击响应时延](performance-delay.md#section118706211961) | 应用，元服务 | 自动，手动 |
| [点击完成时延](performance-delay.md#section2406192820717) |
| web页面滑动 | [滑动响应时延](performance-delay.md#section1767913186810) |
| [滑动卡顿率](performance-frame-rate.md#section159268494256) |
...
| 场景 | 子场景 | 检测指标/检测项 | 应用或元服务场景 | 自动或手动方式 |
| --- | --- | --- | --- | --- |
| 音频播控服务  （从DevEco Studio 5.1.0 Release版本开始支持） | 播控中心音频控制场景 | [播控中心控制音频播放检测](audio-specification.md#section12303131815311) | 应用 | 手动 |
| [播控中心控制音频暂停检测](audio-specification.md#section12303131815311) |
| [播控中心控制歌曲切换上一首检测](audio-specification.md#section12303131815311) |
| [播控中心控制歌曲切换下一首检测](audio-specification.md#section12303131815311) |
| [播控中心控制歌曲播放进度条拖动检测](audio-specification.md#section12303131815311) |
| [播控中心控制歌曲循环播放检测](audio-specification.md#section12303131815311) |
| [播控中心控制歌曲收藏检测](audio-specification.md#section12303131815311) |
| 音频焦点切换  （从DevEco Studio 5.1.0 Release版本开始支持） | 来电接听场景 | [音频焦点变化事件响应检测](audio-specification.md#section256142914530) | 应用 | 手动 |
| VoIP通话场景 |
| 闹钟场景 |
| 导航场景 |
| 语音助手播报场景 |
...
| 非静音播放场景 |
| 普通录音场景 |
| 音频设备控制  （从DevEco Studio 5.1.0 Release版本开始支持） | 耳机控制音频场景 | [耳机控制音频播放检测](audio-specification.md#section12303131815311) | 应用 | 手动 |
| [耳机控制音频暂停检测](audio-specification.md#section12303131815311) |
| [耳机控制歌曲切换上一首检测](audio-specification.md#section12303131815311) |
| [耳机控制歌曲切换下一首检测](audio-specification.md#section12303131815311) |
| 耳机断开场景 | [耳机断开事件响应检测](audio-specification.md#section256142914530) |
| 运行异常  （从DevEco Studio 6.1.0 Beta1版本开始支持） | 运行异常 | [运行无兼容性问题](ide-app-analyzer-all-rules.md#section202813103565) | 应用，元服务 | 自动 |
| [API兼容性问题](ide-api-compatibility-check.md) |
