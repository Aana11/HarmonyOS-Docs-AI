...
在大工程开发过程中，模块较多时会导致内存占用高和代码索引较慢，影响开发效率。

从26.0.0版本开始，DevEco Studio提供加载/卸载模块（Load/Unload Modules）的功能，开发者可以按照需求加载模块，从而降低对内存资源占用和提升代码索引效率。但是，加载/卸载模块功能可能会影响[代码编辑](ide-code-edit.md)能力，具体请参考下面表格。
