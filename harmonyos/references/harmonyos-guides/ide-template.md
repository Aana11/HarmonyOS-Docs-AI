---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-template
title: 工程模板介绍
...
| [CloudDev]Empty Ability | 端云一体化开发通用模板。更多信息请参见[端云一体化开发](agc-harmonyos-clouddevguide.md)。  **约束与限制**：该功能仅支持中国境内（香港特别行政区、澳门特别行政区、中国台湾除外）。 |
...
| [ArkUI-X]Empty Ability | 创建一个展示基础的Hello World功能的模板，构建基于HarmonyOS应用的跨平台应用包。更多信息请参见[ArkUI-X概览](https://gitcode.com/arkui-x/docs/blob/master/zh-cn/ArkUI-X-Overview-zh.md#arkui-x概览)。 |
| [ArkUI-X]Library | 用于基于HarmonyOS应用构建跨平台应用的依赖包。依赖包支持添加到已有的应用中。更多信息请参见[ArkUI-X概览](https://gitcode.com/arkui-x/docs/blob/master/zh-cn/ArkUI-X-Overview-zh.md#arkui-x概览)。 |
| [ArkUI-X]Native C++ | 创建一个调用C++代码的示例工程，构建基于HarmonyOS应用的跨平台应用包。更多信息请参见[ArkUI-X概览](https://gitcode.com/arkui-x/docs/blob/master/zh-cn/ArkUI-X-Overview-zh.md#arkui-x概览)。 |
