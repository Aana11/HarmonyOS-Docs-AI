---
url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-commands
title: 自定义指令（Commands）配置
breadcrumb: 指南 > 使用AI智能辅助编程（不推荐） > 自定义智能体配置 > 自定义指令（Commands）配置
category: harmonyos-guides
scraped_at: 2026-09-17T06:45:45+08:00
doc_updated_at: 2026-08-29
content_hash: sha256:512660fefb3a526bca9da903e353c51ba8bfeea5857393a4dee7da8566404485
---

## 功能介绍

从26.0.0 Beta1版本开始，CodeGenie支持创建自定义指令的功能，该功能允许开发者将常用的提示词和工作流封装为可复用的命令，在CodeGenie对话框中输入`/`，即可快速调用这些指令，无论是执行代码审查、生成测试用例，还是需要快速查询项目规范，自定义指令都能将重复性操作简化为一键式任务，显著提升日常开发效率。
...
1. 点击界面右上方**Settings**按钮，选择**Commands**，进入配置页面。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bb/v3/Gi4Bzs-sQ3eeyB4UkfqOJQ/zh-cn_image_0000002701663656.png)
2. 在**Global Commands**或**Project Commands**下，点击**Create Command**或手动在存储目录下创建指令文件（.md），文件名仅可包含小写字母、数字、中划线，且不以中划线结尾；点击**Import Command**上传指令文件。文档以创建指令文件为例说明。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f8/v3/slGeFdITSRml8mVF20lsAQ/zh-cn_image_0000002701663662.png)
3. 在代码编辑区填写完整的指令内容后，点击**√**保存。

   点击指令文件的开启和关闭按钮，控制是否使用；将鼠标悬浮在指令文件上会显示编辑、删除操作按钮，方便开发者管理。![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ba/v3/_0ilI8cHTsOHQzmC5ZezFg/zh-cn_image_0000002731382879.png)
4. 返回会话，选择**HarmonyOS Ack**智能体或自定义智能体，在对话框内输入`/`指令（如test-test）。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8b/v3/I08y22-wRhe4qOgdh5RbEA/zh-cn_image_0000002701823580.png)
...
最后提供总结
## 注意事项
1. 需要获取修改前后整个文件完整代码进行后续审查，获取代码时需要将其输出到临时文件中，读取后删除文件
