...
content_hash: sha256:a6c49a928e8d78b138a4fc87ef0d3e6d4e6027bba6d86e77da6595c4f2db5e1f
---
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3f/v3/_llwiCMoQyKWWw-7Gej-5A/zh-cn_image_0000002731542107.png)
...
1. 在欢迎页单击**Customize > All settings… > Appearance & Behavior > System Settings > HTTP Proxy**进入HTTP Proxy设置界面。如果已经打开了工程，可以单击**File > Settings**（macOS为**DevEco Studio > Preferences/Settings**） **> Appearance & Behavior > System Settings > HTTP Proxy**进入HTTP Proxy设置界面。
   ...
   * **Proxy authentication**配置项，如果代理服务器需要通过认证鉴权才能访问，则需要配置。否则，请跳过该配置项。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/30/v3/uW37ILAHTv2byZZ8CF4b3Q/zh-cn_image_0000002731542111.png)
...
1. 进入*C:\Users\用户名*目录，打开**.npmrc**文件。如果该目录下没有**.npmrc**文件，请新建一个。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/83/v3/u8JpZELhTI6dRKBYanVucw/zh-cn_image_0000002701822836.png)
2. 修改npm仓库信息，示例如下所示：
...
5. 代理配置完成后，打开命令行工具，执行如下命令验证网络是否正常。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/6Zi4dOACRFKXcqwr7-5lig/zh-cn_image_0000002701662914.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a4/v3/0HyX1CdcSNGi2UDDtZ4bYA/zh-cn_image_0000002731382139.png)
...
5. 代理配置完成后，执行如下命令验证网络是否正常。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/rtTzE5AFS_WEQm_OEuJ0bw/zh-cn_image_0000002701822840.png)
